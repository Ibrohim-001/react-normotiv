  ...
  return (
    <>
      <div className="flex flex-col gap-4 w-[270px]">
        ...
        >
          {isNew && (
            <button className="bg-[#00FF66] text-xs absolute top-4 left-6 text-white px-3 py-1 rounded-sm hover:bg-[#DB4579]">
              NEW!
            </button>
          )}
          <button
          ...
          <div className="absolute top-3 right-3 flex flex-col gap-2">
            <svg
              className="bg-white rounded-full w-[34px] h-[34px] p-2"
              width="18"
              height="16"
              viewBox="0 0 18 16"
              fill="none"
          ...
          {indicators && (
            <div className="flex items-center gap-2">
              <button
                ...
                className={`block w-5 h-5 rounded-full p-1 bg-[#EEFF61]`}
              ></button>
              <button
                style={
                  indicator === true
                ...
                className={`block w-5 h-5 rounded-full p-1 bg-[#DB4444]`}
              ></button>
            </div>
          )}
        </div>
