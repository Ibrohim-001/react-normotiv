        ...
        <div className="flex items-center gap-[130px]">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 mt-10">
              <button className="py-4 bg-[#DB4444] rounded text-white font-medium">
                Create Account
              </button>
              <button className="flex gap-4 py-4 justify-center items-center border border-gray-300 rounded">
                <svg
                  width="24"
                  height="25"
                  viewBox="0 0 24 25"
                ...
                >
                  <g clip-path="url(#clip0_7268_3336)">
                    <path
            ...
            <div className="flex gap-4 justify-center items-center mt-[34px] ">
              <p className="text-[#4c4b4b]">Already have account?</p>
              <Link className="border-b pb-1 border-b-gray-300" to={"/login"}>
                Log in
              </Link>
            </div>
          </div>
